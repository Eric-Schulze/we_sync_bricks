...
func (r *ProfileRepository) GetUserProfile(userID int64) (*models.User, error) {
	...
	user, err := db.QueryRowToStructFromService[models.User](r.db, sql, userID)
	if err != nil {
...
func (r *ProfileRepository) UpdateUserProfile(userID int64, req *ProfileUpdateRequest) (*models.User, error) {
	...
	user, err := db.QueryRowToStructFromService[models.User](r.db, sql, firstName, lastName, req.Email, req.Username, userID)
	if err != nil {
